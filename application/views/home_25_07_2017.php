  ...
  <div class="row" >
	...
	<div class="col-lg-2 col-sm-6">
      <div class="circle-tile"> <a href="<?php echo base_url('employee');?>">
        ...
        <div class="circle-tile-content dark-blue">
          ...
          <div class="circle-tile-number text-faded"> ( <?php echo count( $totalEmployees);?> ) <span id="sparklineA"></span> </div>
    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile"> <a href="<?php echo base_url(); ?>clients">
        ...
        <div class="circle-tile-content green">
          ...
          <div class="circle-tile-number text-faded"> ( <?php echo count( $totalClients);?> )  </div>
    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile"> <a href="<?php echo base_url('projects');?>">
        ...
        <div class="circle-tile-content orange">
          ...
          <div class="circle-tile-number text-faded"> ( <?php echo count( $totalProjects);?> ) </div>
    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile"> <a href="<?php echo base_url('task');?>">
        ...
        <div class="circle-tile-content blue">
          ...
          <div class="circle-tile-number text-faded"> ( <?php echo count( $totalTask);?> ) <span id="sparklineB"></span> </div>
          <a href="<?php echo base_url('task');?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
      </div>
    </div>
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile"> <a href="<?php echo base_url(); ?>timesheet">
        <div class="circle-tile-heading red"> <i class="fa fa-clock-o fa-fw fa-3x"></i> </div>
        </a>
        <div class="circle-tile-content red">
          <div class="circle-tile-description text-faded"> TIMESHEET </div>
          <div class="circle-tile-number text-faded">&nbsp; <span id="sparklineC"></span> </div>
          <a href="<?php echo base_url(); ?>timesheet" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
      </div>
    </div>
	<?php if($this->session->userdata['logged_in_timesheet']['user_type'] == 'manager'): ?>   
   ...
   <?php endif; ?>
      <div class="circle-tile"> <a href="<?php echo base_url('empreports');?>">
        ...
        <div class="circle-tile-content green">
          <div class="circle-tile-description text-faded"> Report Log </div>
          <div class="circle-tile-number text-faded"> ( <?php echo count( $totalDevloperReportLog);?> )  </div>
                ...
                <table class="table table-bordered table-primary nomargin table-hover">
                  ...
                  <tbody>
                   <tr ng-repeat="client in clients">
                      ...
                      <td>{{client.status | capitalize:true}}</td>
                    </tr>
			      </tbody>
                </table>
                ...
                <table class="table table-bordered table-primary table-striped nomargin table-hover">
                  ...
                  <tbody>
				     <tr ng-repeat="project in projects">
					  ...
					  <td>{{project.status | capitalize:true}}</td>
                    </tr>
				</tbody>
                </table>
              </div><!-- table-responsive -->
...
<div class="content-wrapper" ng-app="getRecentDataApp">
  ...
  <div class="row" >
    ...
    <div class="col-lg-4 col-sm-6">
      <div class="circle-tile"> <a href="<?php echo base_url('empreports/searchreportlog');?>">
        <div class="circle-tile-heading orange"> <i class="fa fa-search fa-3x"></i> </div>
        </a>
        <div class="circle-tile-content orange">
          <div class="circle-tile-description text-faded"> Search Report Log </div>
          <div class="circle-tile-number text-faded"> &nbsp;</div>
          <a href="<?php echo base_url('empreports/searchreportlog');?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
      </div>
    </div>
            ...
            <div class="panel-body">             
			 <table class="table table-hover table-bordered">
              ...
              <tbody>
                <?php 
				  $i=1;
				  foreach ($totalDevloperReportLog as $key => $reportResult) :
                ...
                <tr <?php echo $showRowColour; ?> id="delRecordsRow<?php echo $reportResult->emp_record_id; ?>">
                  <td><?php echo $i ?></td>
                  <td nowrap="nowrap"><?php echo ucfirst($reportResult->name);?> </td>
				  ...
				  <td nowrap="nowrap"><?php echo ucfirst($reportResult->task_name);?> </td>
				  <td nowrap="nowrap"><?php echo ucfirst($reportResult->emp_time_hours);?> </td>				  
                  <td nowrap="nowrap"><?php echo $reportResult->status;?></td>
                  <th nowrap="nowrap"><?php echo date('d-F-Y',strtotime($reportResult->emp_report_dates));?></th>
                  </tr>
                <?php $i++; endforeach; ?>
              </tbody>
            </table>
